...
function getAbas(ss) {
  ...
  return data
    ...
    .map(r=>({col1:String(r[0]||"").trim(),col2:String(r[1]||"").trim(),col3:String(r[2]||"").trim()}))
    .filter(r=>!(r.col1==="ID"&&r.col2==="Nome"));
}
